...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "📚 Bajka dla dzieci!\n\n#BajkiDlaDzieci #Polski #Edukacja"
        ...
        video = upload.video(
            ...
            name=title or 'Bajka dla dzieci',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Bajka dla dzieci! 📚"
    title = sys.argv[3] if len(sys.argv) > 3 else "Bajka dla dzieci"
